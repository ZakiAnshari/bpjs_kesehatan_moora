            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center" style="    margin: 0px 0 20px;">
                ...
                <div style="display: flex; justify-content: center; align-items: center; height: auto;">
                  <img src="{{ asset('/backend/assets/img/avatars/logo.png') }}" alt="Logo" width="150" height="150" >
                </div>
              ...
              <!-- /Logo -->
                ...
                <p class="mb-4">Masuk untuk menentukan masyarakat yang berhak menerima bantuan kesehatan di BPJS Kesehatan Padang Panjang menggunakan metode MOORA.</p>
