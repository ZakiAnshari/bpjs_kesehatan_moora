                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                ...
                                <p class="mb-4">
                                    Anda berperan penting dalam menentukan masyarakat yang layak menerima bantuan kesehatan
                                    di BPJS Kesehatan Padang Panjang melalui sistem pendukung keputusan berbasis metode
                                    MOORA.
                                </p>
                            </div>
                        </div>
